  ...
  <div class="rr_all">
    ...
    <div class="part_1" v-show="part_show[0].isShow">
      <div class="con_search">
        ...
        <el-button type="primary" class="con_search_submit" @click="search_phone()">搜索
        </el-button>
        <el-select style="margin-left: 5%" v-model="value1"  @change="change_user_source()" placeholder="请选择用户来源">
          <el-option
        ...
        <el-select style="margin-left: 5%" v-model="value2" @change="change_arrive()" placeholder="请选择是否到账">
          <el-option
        ...
        <el-select style="margin-left: 5%" v-model="value3" @change="change_backstage_payment()" placeholder="请选择是否后台打款">
          <el-option
  ...
  import {getAcceptRecord,getExchangeType,reTryPlay} from '../api/interface'
    export default {
      ...
      methods:{
          /*part_1 改变用户来源*/
        change_user_source(){
          let data={"phone":this.save_search_value,"address":"","exchangeType":this.value1,"backgroundPlay":this.value3,"status":this.value2,"page":1,"pageSize":10}
          this.getdata(data,0)
          this.currentPage=1
        },
        /*part_1 改变是否到账*/
        ...
        get_user_source(){
          ...
          /*初始化数据*/
        initialization_data(){
          let data={"phone":"","address":"","exchangeType":"","backgroundPlay":"","status":"","page":1,"pageSize":10}
          this.getdata(data,0)
        },
          /*公共数据方法*/
        getdata(e,q,type){
        ...
        swich_tab(e){
          ...
          if(e==0){
            ...
            let data={"phone":"","address":"","exchangeType":"","backgroundPlay":"","status":"1","page":1,"pageSize":10}
            this.getdata(data,1)
          }else if(e==2){
            let data={"phone":"","address":"","exchangeType":"","backgroundPlay":"","status":"0","page":1,"pageSize":10}
            this.getdata(data,2)
          }
          this.currentPage=1
        ...
        search_phone(){
            ...
            this.value3=''
          this.currentPage=1
            let data={"phone":this.search,"address":"","exchangeType":"","backgroundPlay":"","status":"","page":1,"pageSize":10}
            this.getdata(data,0)
        },
        /*part_1分页切换*/
        currentPageChange(e) {
          this.currentPage=e
          let data={"phone":this.save_search_value,"address":"","exchangeType":this.value1,"backgroundPlay":this.value3,"status":this.value2,"page":this.currentPage,"pageSize":10}
          this.getdata(data,0)
        },
        /*part_2利用手机号进行检索*/
        search_phone_1(){
          this.select_value=''
          this.currentPage_1=1
          let data={"phone":this.search_1,"address":"","exchangeType":"","backgroundPlay":"","status":"1","page":1,"pageSize":10}
          this.getdata(data,1)
        },
        /*part_2分页切换*/
        currentPageChange_1(e) {
          this.currentPage_1=e
          let data={"phone":this.save_search_value_1,"address":"","exchangeType":this.select_value,"backgroundPlay":"","status":"1","page":this.currentPage_1,"pageSize":10}
          this.getdata(data,1)
        },
        /*part_2 改变用户来源*/
        change_user_source_1(){
          console.log('111')
          let data={"phone":this.save_search_value_1,"address":"","exchangeType":this.select_value,"backgroundPlay":"","status":"1","page":1,"pageSize":10}
          this.getdata(data,1)
          this.currentPage_1=1
        },
        /*part_3改变用户来源*/
        change_user_source_2(){
          let data={"phone":this.save_search_value_2,"address":"","exchangeType":this.select_value_1,"backgroundPlay":"","status":"0","page":1,"pageSize":10}
          this.getdata(data,2)
          this.currentPage_2=1
        },
        /*part_3分页切换*/
        currentPageChange_2(e) {
          ...
          let data={"phone":this.save_search_value_2,"address":"","exchangeType":this.select_value_1,"backgroundPlay":"","status":"0","page":this.currentPage_2,"pageSize":10}
          this.getdata(data,2)
        },
        /*part_3重试*/
        retry(e){
        ...
        search_phone_2(){
          this.select_value_1=''
          let data={"phone":this.search_2,"address":"","exchangeType":"","backgroundPlay":"","status":"0","page":1,"pageSize":10}
          this.getdata(data,2)
          this.currentPage_2=1
        },
      },
