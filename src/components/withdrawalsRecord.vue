<template>
  <div class="wr_all">
    ...
    <el-dialog
      ...
      width="30%"
      >
      <span>是否确认进行该批次提现，发送申请给交易所并发送邮件到交易所地址</span>
      <br>
      <!--<span style="margin-top: 20px;display: inline-block">请输入接收验证码的手机号</span>-->
      <el-input  style="width: 70%;margin-top: 30px" v-model="verify_phone_number" placeholder="请输入接收验证码的手机号"></el-input>
    ...
    >
      ...
      <br>
      <el-input  style="width: 70%;margin-top: 30px" v-model="verify_phone_number_1" placeholder="请输入用户新的交易所地址"></el-input>
      <span slot="footer" class="dialog-footer">
    ...
    <div class="part_6" v-show="part_show[5].is_true">
      <div class="con_search" style="width: 70%;">
        ...
        <el-select style="left: -20%;position: relative" v-model="select_value1_2" placeholder="请选择提现交易所">
          <el-option
            v-for="item in options"
            :key="item.typeId"
            :label="item.typeName"
...
<script>
  import {getWithdrawalRecord,getExchangeType,reviewBatch} from '../api/interface'
    export default {
      ...
      methods:{
        ...
        Initialization_data_1(){
            this.currentPage=1
            let data={"phone":"","address":"","exchangeType":"","page":1,"pagesize":10,"reviewBatch":"","status":''}
        ...
        Initialization_data_4(){
          ...
          this.select_value1=''
          this.select_value2=''
          let data={"phone":"","address":"","exchangeType":"","page":1,"pagesize":10,"reviewBatch":"","status":"1"}
        ...
        Initialization_data_5(){
          ...
          let data={"phone":"","address":"","exchangeType":"","page":1,"pagesize":10,"reviewBatch":"","status":"0"}
        ...
        currentPageChange(e) {
          this.currentPage=e
          let data={"phone":"","address":"","exchangeType":"","page":this.currentPage,"pagesize":10,"reviewBatch":"","status":''}
          this.get_data_1(data)
        },
        /*part_2 分页切换*/
        ...
        currentPageChange_3(e) {
          ...
          if(this.part_4_recording.length==11){
            let data={"phone":this.part_4_recording,"address":"","exchangeType":this.select_value1,"page":this.currentPage_3,"pagesize":10,"reviewBatch":this.select_value2,"status":'1'}
          }else {
            let data={"phone":"","address":this.part_4_recording,"exchangeType":this.select_value1,"page":this.currentPage_3,"pagesize":10,"reviewBatch":this.select_value2,"status":'1'}
          }
          this.get_data_4(data,0)
        },
        /*part_5 分页切换*/
        currentPageChange_4(e) {
          ...
          let data
          if(this.part_4_recording.length==11){
            data={"phone":this.part_4_recording,"address":"","exchangeType":this.select_value1_1,"page":this.currentPage_4,"pagesize":10,"reviewBatch":this.select_value2_1,"status":"0"}
          }else {
            data={"phone":'',"address":this.part_4_recording,"exchangeType":this.select_value1_1,"page":this.currentPage_4,"pagesize":10,"reviewBatch":this.select_value2_1,"status":"0"}
          }
          this.get_data_5(data,0)
        },
        /*part_6 分页切换*/
        ...
        dialog_sure(){
          this.dialogVisible=false
          console.log(this.verify_phone_number)
        },
        /*part4 提现成功检索*/
        search_more(){
          this.select_value1=''
          ...
          if(this.search_more_vlue.length==11){
            let data={"phone":this.search_more_vlue,"address":"","exchangeType":"","page":1,"pagesize":10,"reviewBatch":"","status":"1"}
        ...
        pa_search_4_1(){
          let data
          if(this.part_4_recording.length==11){
            data={"phone":this.part_4_recording,"address":"","exchangeType":this.select_value1,"page":1,"pagesize":10,"reviewBatch":this.select_value2,"status":"1"}
          }else {
            data={"phone":'',"address":this.part_4_recording,"exchangeType":this.select_value1,"page":1,"pagesize":10,"reviewBatch":this.select_value2,"status":"1"}
          }
          this.get_data_4(data,0)
        },
        /*part4 审核批次检索*/
        ...
        pa_search_5_1(){
          ...
          if(this.part_5_recording.length==11){
            data={"phone":this.part_5_recording,"address":"","exchangeType":this.select_value1_1,"page":1,"pagesize":10,"reviewBatch":this.select_value2_1,"status":"0"}
          }else {
            data={"phone":'',"address":this.part_5_recording,"exchangeType":this.select_value1_1,"page":1,"pagesize":10,"reviewBatch":this.select_value2_1,"status":"0"}
          }
          this.get_data_5(data,0)
        },
        /*part5 审核批次检索*/
        ...
        search_more_1(){
          ...
          if(this.search_more_vlue_1.length==11){
            let data={"phone":this.search_more_vlue_1,"address":"","exchangeType":"","page":1,"pagesize":10,"reviewBatch":"","status":"0"}
        ...
        /*part_6 退款检索*/
        search_more_2(){
          console.log(this.search_more_vlue_2)
        },
      },
      created(){
        this.getdata_public()
